...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			...
			<p>Vào lúc ${donhang.getNgayDatHang()} chúng tôi đã nhận được đơn đặt hàng với những sản phẩm
				như sau:</p><br>
			...
			<br>
			<p>LaptopShop xin chân thành cảm ơn quý khách hàng đã tin tưởng sử dụng dịch vụ, sản phẩm của
				chúng tôi</p><br>
